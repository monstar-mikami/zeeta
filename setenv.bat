...
@set CLS=.\;bin
@set CLS=%CLS%;lib\h2\h2.jar
@set CLS=%CLS%;lib\s2\aopalliance-1.0.jar
@set CLS=%CLS%;lib\s2\commons-logging-1.1.jar
@set CLS=%CLS%;lib\s2\geronimo-jta_1.0.1B_spec-1.0.jar
@rem @set CLS=%CLS%;lib\s2\hsqldb-1.8.0.1.jar
@set CLS=%CLS%;lib\s2\javassist-3.4.ga.jar
