@set SELJ_HOME="C:\Documents and Settings\mikami\My Documents\project\javaWork\selj"
...
@set CLS=%CLS%;%SELJ_LIB%\s2\s2-extension-2.4.22.jar
@set CLS=%CLS%;%SELJ_LIB%\s2\s2-framework-2.4.22.jar
@set CLS=%CLS%;%SELJ_LIB%\s2dao\s2-dao-1.0.47.jar
@set CLS=%CLS%;%SELJ_LIB%\s2dao_tiger\s2-dao-tiger-1.0.47.jar
